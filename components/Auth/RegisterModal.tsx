...
export default function RegisterModal({ isOpen, onClose, onSwitchToLogin }: RegisterModalProps) {
  ...
  const { register, signupWithGoogle, signupWithMicrosoft } = useAuth();
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      // For Google signup, you'll need to implement Google OAuth flow
      // This is a placeholder - you'll need to integrate with Google OAuth SDK
      alert('Google signup integration required. Please implement Google OAuth SDK.');
      // const googleToken = await getGoogleToken(); // Implement this
      // await signupWithGoogle(googleToken);
      // onClose();
    } catch (err: any) {
  ...
  const handleMicrosoftSignup = async () => {
    ...
    try {
      // For Microsoft signup, you'll need to implement Microsoft OAuth flow
      // This is a placeholder - you'll need to integrate with Microsoft OAuth SDK
      alert('Microsoft signup integration required. Please implement Microsoft OAuth SDK.');
      // const microsoftToken = await getMicrosoftToken(); // Implement this
      // await signupWithMicrosoft(microsoftToken);
      // onClose();
    } catch (err: any) {
